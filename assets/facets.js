  ...
  onSubmitHandler(event) {
    ...
    if (event.srcElement.className == 'mobile-facets__checkbox') {
      ...
      sortFilterForms.forEach((form) => {
        if (!isMobile) {
          if (form.id === 'FacetSortForm' || form.id === 'FacetFiltersForm' || form.id === 'FacetSortDrawerForm' || form.id === 'mlDesktopSortForm' || form.querySelector('[name="sort_by"]')) {
...
/* ==========================================================================
   LUXURY FILTER DRAWER & CARD VARIANT SWITCHER CONTROLLER
   ========================================================================== */

(function () {
  function initDrawerAndPills() {
    const drawer = document.getElementById('mlFilterDrawer');
    const openBtn = document.getElementById('mlFilterOpenBtn');
    ...
    document.addEventListener('click', function (e) {
      if (e.target.closest('#mlFilterOpenBtn')) {
        openDrawer();
    ...
    // Handle variant pill selection on product cards
    document.addEventListener('click', function (e) {
      ...
      card.querySelectorAll('.ml-variant-pill-btn').forEach((b) => b.classList.remove('is-selected'));
      pill.classList.add('is-selected');

      const variantId = pill.getAttribute('data-variant-id');
      const price = pill.getAttribute('data-price');
      const comparePrice = pill.getAttribute('data-compare');
      const isAvailable = pill.getAttribute('data-available') === 'true';
      ...
      const currentPriceEl = card.querySelector('.ml-card-price--current');
      if (currentPriceEl && price) currentPriceEl.textContent = price;

      const oldPriceEl = card.querySelector('.ml-card-price--old');
      if (oldPriceEl) {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initDrawerAndPills);
  } else {
    initDrawerAndPills();
  }
})();
